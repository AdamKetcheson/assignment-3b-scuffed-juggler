...
function home({ uid, todo, category, startDate, endDate, status, theme }) {
  ...
  const template = `
    <section class="border-l-8 border-pink-500/80 py-4 px-5   mb-1 bg-white mx-auto  ">
    <header class="flex items-center justify-between">
      <h2 class="font-semibold text-[10px] text-pink-600/80  bg-red-50 px-2 py-0.5 rounded-md   w-fit" >
